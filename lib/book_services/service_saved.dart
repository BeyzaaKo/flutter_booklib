...
class SavedBookServices {
  Future<List<BookData>> getSavedBooks() async {
    ...
    try {
      ...
      for (String subject in genres) {
        var url =
            'https://www.googleapis.com/books/v1/volumes?q=subject:fiction&orderBy=newest&maxResults=18';
        ...
        if (response.statusCode == 200) {
          ...
          print(
              'Error fetching saved books for $subject: ${response.statusCode}');
